        ...
        return (
            <View style={{ flex: 1 }}>
                <ScrollView style={styles.container}>
                    <Image source={require('../assets/images/profile.jpg')} resizeMode="stretch" style={{ height: 350, width: width }} />
                    ...
                    <View style={styles.commons}>
                        ...
                        >
                            <View style={{}}>
                                <Image source={require('../assets/images/profile.jpg')} resizeMode="stretch" style={{ height: 100, width: 100, margin: 5 }} />
                                <Image source={require('../assets/images/profile.jpg')} resizeMode="stretch" style={{ height: 100, width: 100, margin: 5 }} />
                            </View>
                            <View style={{}}>
                                <Image source={require('../assets/images/profile.jpg')} resizeMode="stretch" style={{ height: 100, width: 100, margin: 5 }} />
